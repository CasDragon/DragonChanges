...
{
    internal class CrackDustyRosePrismItem
    {
        // edit
        internal const string item = "CrackDustyRosePrismItem";
        internal const string itemguid = Guids.CrackDustyRosePrismItem;
        internal const string settingName = "iounstones";
        // don't edit
        [DragonLocalizedString(itemname, "Cracked Dusty Rose Prism - Ioun Stone")]
        internal const string itemname = $"{item}.name";
        [DragonLocalizedString(itemdescription, "This stone grants a +1 competence bonus on initiative checks.")]
        ...
        public static void Configure()
        {
            ...
            else
            {
                ...
                ConfigureDummy();
                CrackDustyRosePrismAbility.ConfigureDummy();
                CrackDustyRosePrismBuff.ConfigureDummy();
            }
        }
        ...
        public static void ConfigureEnabled()
        {
            BlueprintItemEquipmentUsable itembp = ItemEquipmentUsableConfigurator.New(item, itemguid)
                ...
                .SetActivatableAbility(CrackDustyRosePrismAbility.ConfigureEnabled())
                .Configure();
