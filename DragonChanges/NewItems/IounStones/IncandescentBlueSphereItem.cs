...
{
    internal class IncandescentBlueSphereItem
    {
        // edit
        internal const string item = "IncandescentBlueSphereItem";
        internal const string itemguid = Guids.IncandescentBlueSphereItem;
        internal const string settingName = "iounstones";
        // don't edit
        [DragonLocalizedString(itemname, "Incandescent Blue Sphere - Ioun Stone")]
        internal const string itemname = $"{item}.name";
        [DragonLocalizedString(itemdescription, "This stone grants you a +2 enhancement bonus to Wisdom. The bonuses from multiple spheres stack (up to a maximum of a +10 enhancement bonus to Wisdom).")]
        ...
        public static void Configure()
        {
            ...
            else
            {
                ...
                ConfigureDummy();
                IncandescentBlueSphereAbility.ConfigureDummy();
                IncandescentBlueSphereBuff.ConfigureDummy();
            }
        }
        ...
        public static void ConfigureEnabled()
        {
            BlueprintItemEquipmentUsable itembp = ItemEquipmentUsableConfigurator.New(item, itemguid)
                ...
                .SetActivatableAbility(IncandescentBlueSphereAbility.ConfigureEnabled())
                .Configure();
