...
public class ElectricRayScroll
{
    // edit
    private const string item = "ElectricRayScroll";
    private const string itemguid = Guids.ElectricRayScroll;
    ...
    public static void ConfigureEnabled()
    {
        ...
        if (SettingsAction.GetSetting<bool>("darthicons"))
            spritepath = "Darth.Hellshock_Ray_Scroll.png";
