...
{
    internal class CommunalEaglesoulScroll
    {
        // edit
        internal const string item = "communaleaglesoulscroll";
        internal const string itemguid = Guids.communaleaglesoulscroll;
        internal const string settingName = "communaleaglesoulscroll";
        ...
        public static void ConfigureEnabled(BlueprintAbility ability)
        {
            BlueprintItemEquipmentUsable scroll = ItemEquipmentUsableConfigurator.New(item, itemguid)
                ...
                .AddCopyScroll()
                .SetIcon(ItemEquipmentUsableRefs.ScrollOfEaglesoul.Reference.Get().Icon)
                .Configure();
