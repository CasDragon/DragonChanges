...
{
    internal class CommnualSenseVitalsScroll
    {
        // edit
        internal const string item = "CommnualSenseVitalsScroll";
        internal const string itemguid = Guids.CommnualSenseVitalsScroll;
