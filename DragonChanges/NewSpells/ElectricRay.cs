...
public class ElectricRay
{
        // edit
        internal const string spell = "ElectricRay";
        ...
        internal const string sdescription =
            "A blast of hell lightning blazes from your hands. You can fire one ray, plus one additional ray for every 4 {g|Encyclopedia:Caster_Level}caster levels{/g} " +
            ...
            "{g|Encyclopedia:Energy_Damage}electric damage{/g}, but the other half results directly from unholy power and is therefore not subject " +
            "to being reduced by electric {g|Encyclopedia:Energy_Resistance}resistance{/g}.";
        ...
        public static void ConfigureEnabled()
        {
            ...
            if (SettingsAction.GetSetting<bool>("darthicons"))
                spritepath = "Darth.Hellshock_Ray.png";
            ...
            var x = AbilityConfigurator.NewSpell(spell, spellguid, SpellSchool.Evocation, 
                    true, SpellDescriptor.Electricity | SpellDescriptor.Evil)
