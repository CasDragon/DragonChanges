...
public class ColdRay
{
        // edit
        internal const string spell = "ColdRay";
        internal const string spellguid = Guids.ColdRay;
        internal const string settingName = "elementalray";
        // don't edit
        [DragonLocalizedString(spellname, "Hellice Ray")]
        ...
        internal const string sdescription =
            "A blast of hellice blazes from your hands. You can fire one ray, plus one additional ray for every 4 {g|Encyclopedia:Caster_Level}caster levels{/g} " +
            ...
            "{g|Encyclopedia:Energy_Damage}cold damage{/g}, but the other half results directly from unholy power and is therefore not subject " +
            "to being reduced by cold {g|Encyclopedia:Energy_Resistance}resistance{/g}.";
        ...
        public static void ConfigureEnabled()
        {
            ...
            AbilityConfigurator.NewSpell(spell, spellguid, SpellSchool.Evocation, true, SpellDescriptor.Fire | SpellDescriptor.Good)
                ...
                .AddAbilityDeliverProjectile(
                        projectiles: [ProjectileRefs.RayOfFrost00.Reference.Get(),
