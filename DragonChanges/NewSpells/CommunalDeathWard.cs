    ...
    internal class CommunalDeathWard
    {
        ...
        public static BlueprintAbility ConfigureEnabled()
        {
            BlueprintAbility x = AbilityConfigurator.New(ability, abilityguid)
                ...
                .AddSpellListComponent(6, SpellListRefs.ClericSpellList.Reference.Get())
                .AddSpellListComponent(7, SpellListRefs.DruidSpellList.Reference.Get())
                .AddSpellListComponent(7, SpellListRefs.PaladinSpellList.Reference.Get())
                .AddSpellListComponent(7, SpellListRefs.AlchemistSpellList.Reference.Get())
                .AddSpellListComponent(7, SpellListRefs.InquisitorSpellList.Reference.Get())
                .AddSpellListComponent(7, SpellListRefs.ReposeDomainSpellList.Reference.Get())
                .AddSpellListComponent(7, SpellListRefs.KnowledgeDomainSpellList.Reference.Get())
                .AddSpellListComponent(7, SpellListRefs.WitchSpellList.Reference.Get())
                .AddSpellListComponent(7, SpellListRefs.SpiritWardenSpellList.Reference.Get())
                .AddSpellListComponent(7, SpellListRefs.LichWizardSpelllist.Reference.Get())
                .AddSpellListComponent(7, SpellListRefs.HunterSpelllist.Reference.Get())
                .AddSpellListComponent(7, SpellListRefs.AeonSpellList.Reference.Get())
                .AddSpellListComponent(7, SpellListRefs.MagicDeceiverSpellList.Reference.Get())
