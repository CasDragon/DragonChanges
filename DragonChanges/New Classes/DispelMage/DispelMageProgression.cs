...
public class DispelMageProgression
{
    // edit
    internal static string progressionprefix = "archmage";
    internal static string progressionguid = Guids.ArchmageProgression;
    // don't edit
    ...
    public static BlueprintProgression ConfigureEnabled()
    {
        ...
        return ProgressionConfigurator.New(progressionname, progressionguid)
            ...
            .SetClasses([Guids.ArchmageClass])
            .Configure();
    }
}