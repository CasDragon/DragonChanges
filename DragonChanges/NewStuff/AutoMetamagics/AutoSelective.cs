...
namespace DragonChanges.NewStuff.AutoMetamagics
{
    ...
    { 
        // edit
        internal const string feature = "AutoSelective";
        internal const string featureguid = Guids.AutoSelective;
        // don't edit
        ...
        public static BlueprintActivatableAbility ConfigureAbility()
        {
            return ActivatableAbilityConfigurator.New(ability, abilityguid)
                ...
                .SetIcon(MicroAssetUtil.GetAssemblyResourceSprite("Abilities.AutoSelective.png"))
                .Configure();
        }
        // edit
