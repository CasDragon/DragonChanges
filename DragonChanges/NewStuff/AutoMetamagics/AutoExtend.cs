...
namespace DragonChanges.NewStuff.AutoMetamagics
{
    ...
    {
        // edit
        internal const string feature = "AutoExtend";
        internal const string featureguid = Guids.AutoExtend;
        // don't edit
        ...
        public static BlueprintActivatableAbility ConfigureAbility()
        {
            return ActivatableAbilityConfigurator.New(ability, abilityguid)
                ...
                .SetIcon(MicroAssetUtil.GetAssemblyResourceSprite("Abilities.AutoExtend.png"))
                .Configure();
        }
        // edit
