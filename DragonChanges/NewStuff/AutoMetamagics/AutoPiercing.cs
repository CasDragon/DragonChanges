    ...
    internal class AutoPiercing
    {
        ...
        public static void ConfigureEnabled()
        {
            BlueprintFeature x = FeatureConfigurator.New(feature, featureguid)
                ...
                .AddRecommendationHasFeature(FeatureRefs.PiercingSpell.Reference.Get())
                .AddPrerequisiteFeature(FeatureRefs.PiercingSpell.Reference.Get())
                .AddToGroups(FeatureGroup.MythicAbility)
                .AddFacts(new() { ConfigureAbility() })
                .Configure();
            FeatureConfigurator.For(FeatureRefs.PiercingSpell)
                .AddToIsPrerequisiteFor(x)
                .Configure();
        }
        // edit
        internal static string ability = "AutoPiercing-ability";
        internal static string abilityguid = Guids.AutoPiercingAbility;
        // don't edit
        ...
        // edit
        internal static string buff = "AutoPiercing-buff";
        internal static string buffguid = Guids.AutoPiercingBuff;
        // don't edit
        ...
        public static BlueprintBuff ConfigureBuff()
        {
            return BuffConfigurator.New(buff, buffguid)
                ...
                .AddAutoMetamagic(metamagic: Metamagic.Piercing)
