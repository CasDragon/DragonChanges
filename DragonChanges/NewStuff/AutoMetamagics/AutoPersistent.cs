...
namespace DragonChanges.NewStuff.AutoMetamagics
{
    ...
    { 
        // edit
        internal const string feature = "AutoPersistent";
        internal const string featureguid = Guids.AutoPersistent;
        // don't edit
        ...
        public static void ConfigureEnabled()
        {
            BlueprintFeature x = FeatureConfigurator.New(feature, featureguid)
                ...
                .Configure();
            FeatureConfigurator.For(FeatureRefs.PersistentSpellFeat)
        ...
        public static BlueprintActivatableAbility ConfigureAbility()
        {
            return ActivatableAbilityConfigurator.New(ability, abilityguid)
                ...
                .SetIcon(MicroAssetUtil.GetAssemblyResourceSprite("Abilities.AutoPersistent.png"))
                .Configure();
        }
        // edit
