...
namespace DragonChanges.NewStuff.AutoMetamagics
{
    internal class AutoEncourage
    {
        ...
        {
            SimpleBlueprint encourage = BlueprintTool.GetRef<BlueprintFeatureReference>("392608e8033a409ab96afdfbf315e028").GetBlueprint();
            BlueprintFeature x = FeatureConfigurator.New(feature, featureguid)
                .SetDisplayName(featurename)
                .SetDescription(featuredescription)
                .AddRecommendationRequiresSpellbook()
                .AddRecommendationHasFeature(encourage)
                .AddPrerequisiteFeature(encourage)
                .AddToGroups(FeatureGroup.MythicAbility)
                .AddFacts(new() { ConfigureAbility() })
                .Configure();
            FeatureConfigurator.For("392608e8033a409ab96afdfbf315e028")
                .AddToIsPrerequisiteFor(x)
                .Configure();
        }
        // edit
        internal static string ability = "AutoEncourage-ability";
        internal static string abilityguid = Guids.AutoEncourageAbility;
        // don't edit
        ...
        public static BlueprintActivatableAbility ConfigureAbility()
        {
            return ActivatableAbilityConfigurator.New(ability, abilityguid)
                ...
                .SetIcon(MicroAssetUtil.GetAssemblyResourceSprite("Abilities.AutoEncourage.png"))
                .Configure();
        }
        // edit
        internal static string buff = "AutoEncourage-buff";
        internal static string buffguid = Guids.AutoEncourageBuff;
        // don't edit
        ...
        public static BlueprintBuff ConfigureBuff()
        {
            return BuffConfigurator.New(buff, buffguid)
                ...
                .AddAutoMetamagic(metamagic: (Metamagic)CustomMetamagic.Encouraging)
