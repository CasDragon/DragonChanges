    ...
    internal class CraneTrace
    {
        ...
        public static BlueprintBuff ConfigureBuff()
        {
            return BuffConfigurator.New(buff, buffguid)
                ...
                .AddFeatureIfHasFact(checkedFact: FeatureRefs.CraneStyleFeat.Reference.Get(), feature: FeatureRefs.CraneStyleFeat.Reference.Get(), not: true)
                .SetIsClassFeature(true)
